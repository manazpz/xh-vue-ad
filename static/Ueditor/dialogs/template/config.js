...
var templates = [
    ...
    },
    {
      "pre":"table0.png",
      'title':lang.table,
      'preHtml':'<table class="tm-tableAttr" width="789">\n' +
      '    <thead style="margin: 0px; padding: 0px; background-color: rgb(238, 238, 238); border-bottom: 1px solid rgb(228, 228, 228); font-weight: 700; font-size: 14px; color: rgb(153, 153, 153);">\n' +
      '        <tr style="margin: 0px; padding: 0px;" class="firstRow">\n' +
      '            <td colspan="2" style="margin: 0px; padding-right: 5px; padding-left: 20px; border-bottom-color: rgb(229, 229, 229);">\n' +
      '                规格参数\n' +
      '            </td>\n' +
      '        </tr>\n' +
      '    </thead>\n' +
      '    <tbody style="margin: 0px; padding: 0px;">\n' +
      '        <tr class="tm-tableAttrSub" style="margin: 0px; padding: 0px;">\n' +
      '            <th colspan="2" style="margin: 0px; padding-right: 5px; padding-left: 20px; text-align: left; width: 763px; border-top-color: rgb(229, 229, 229); border-right-color: rgb(229, 229, 229);">\n' +
      '                拍照功能\n' +
      '            </th>\n' +
      '        </tr>\n' +
      '        <tr style="margin: 0px; padding: 0px;">\n' +
      '            <th style="margin: 0px; padding-right: 5px; padding-left: 20px; color: rgb(153, 153, 153); font-weight: 400; text-align: right; width: 147px; border-top-color: rgb(247, 247, 247); border-right-color: rgb(247, 247, 247);">\n' +
      '                后置摄像头\n' +
      '            </th>\n' +
      '            <td style="margin: 0px; padding-right: 5px; padding-left: 5px; border-top-color: rgb(247, 247, 247);">\n' +
      '                &nbsp;1600万+800万\n' +
      '            </td>\n' +
      '        </tr>\n' +
      '        <tr style="margin: 0px; padding: 0px;">\n' +
      ...
      '            </th>\n' +
      '            <td style="margin: 0px; padding-right: 5px; padding-left: 5px; border-top-color: rgb(247, 247, 247);">\n' +
      '                &nbsp;MP4,3GP,3GP2,WEBM,AVI,MKV,MOV,H.265(HEVC),WMV,TS,FLV\n' +
      '            </td>\n' +
      '        </tr>\n' +
      '        <tr class="tm-tableAttrSub" style="margin: 0px; padding: 0px;">\n' +
      '            <th colspan="2" style="margin: 0px; padding-right: 5px; padding-left: 20px; text-align: left; width: 763px; border-top-color: rgb(229, 229, 229); border-right-color: rgb(229, 229, 229);">\n' +
      ...
      '            </th>\n' +
      '            <td style="margin: 0px; padding-right: 5px; padding-left: 5px; border-top-color: rgb(247, 247, 247);">\n' +
      '                &nbsp;拍照手机&nbsp;音乐手机&nbsp;时尚手机&nbsp;智能手机&nbsp;3G手机&nbsp;4G手机&nbsp;女性手机&nbsp;备用手机\n' +
      '            </td>\n' +
      '        </tr>\n' +
      '        <tr style="margin: 0px; padding: 0px;">\n' +
      '            <th style="margin: 0px; padding-right: 5px; padding-left: 20px; color: rgb(153, 153, 153); font-weight: 400; text-align: right; width: 147px; border-top-color: rgb(247, 247, 247); border-right-color: rgb(247, 247, 247);">\n' +
      ...
      '    <br/>\n' +
      '</p>',
      "html":'<table class="tm-tableAttr" width="789">\n' +
      '    <thead style="margin: 0px; padding: 0px; background-color: rgb(238, 238, 238); border-bottom: 1px solid rgb(228, 228, 228); font-weight: 700; font-size: 14px; color: rgb(153, 153, 153);">\n' +
      '        <tr style="margin: 0px; padding: 0px;" class="firstRow">\n' +
      '            <td colspan="2" style="margin: 0px; padding-right: 5px; padding-left: 20px; border-bottom-color: rgb(229, 229, 229);">\n' +
      '                [键入标题]\n' +
